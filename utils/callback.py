    ...
    def on_save(self,
        ...
        if args.local_rank == 0 or args.local_rank == -1:
            ...
            if os.path.exists(state.best_model_checkpoint):
                ...
                kwargs['model'].whisper_model.save_pretrained(best_checkpoint_folder + '/asr_model')
                torch.save(kwargs['model'].srl_model.state_dict(), best_checkpoint_folder + "/srl_model.pth")
