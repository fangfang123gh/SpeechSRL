...
add_arg("lora_model", type=str, default="", help="微调保存的模型路径")
add_arg('output_dir', type=str, default='',    help="合并模型的保存目录")
...
# 保存模型到指定目录中
# model.save_pretrained(save_directory, max_shard_size='16GB')
