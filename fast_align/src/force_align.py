...
class Aligner:
    ...
    def __init__(self, fwd_params, fwd_err, rev_params, rev_err, heuristic='grow-diag-final-and'):
        ...
        self.rev_cmd = rev_cmd
        self.tools_cmd = tools_cmd

    def align(self, line):
        self.fwd_align = popen_io(self.fwd_cmd)
        self.rev_align = popen_io(self.rev_cmd)
        self.tools = popen_io(self.tools_cmd)
